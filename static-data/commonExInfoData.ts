export const athletic = [
  ...
  { key: "Made In", required: true },
  { key: "Country of Origin", required: true },
  { key: "Box content", required: false },
  { key: "Size", required: false },
];
export const badminton = [
  { key: "Material", required: true, sameOrder: true },
  { key: "Container Type", required: true, sameOrder: true },
  { key: "Age Range", required: true, sameOrder: true },
  { key: "Made In", required: true },
  { key: "Country of Origin", required: true },
  { key: "Manufacturer", required: true },
  { key: "League", required: true },
  { key: "Item Weight", required: false },
];

export const bodyCare = [
  { key: "Skin Type", required: true, sameOrder: true },
  { key: "Scent", required: true, sameOrder: true },
  { key: "Age range", required: true, sameOrder: true },
  { key: "Maximum Use", required: true, sameOrder: true },
  { key: "Item Form", required: true, sameOrder: true },
  { key: "Product Benefits", required: true },
  { key: "Container Type", required: true },
  { key: "Net Quantity", required: false },
  { key: "Country of Origin", required: true },
  { key: "Material Type Free", required: false },
];
export const chess = [
  { key: "Material", required: true, sameOrder: true },
  { key: "Manufacturer", required: true },
...
export const fitness = [
  { key: "Material", required: true, sameOrder: true },
  { key: "Recommend", required: true, sameOrder: true },
  { key: "Age Range", required: true, sameOrder: true },
...
export const hairCare = [
  { key: "Hair Type", required: true, sameOrder: true },
  { key: "Age Range", required: true, sameOrder: true },
  { key: "Scent", required: true, sameOrder: true },
  { key: "Material Type Free", required: true, sameOrder: true },
  { key: "Item Form", required: true, sameOrder: true },
  { key: "Product Benefits", required: true },
  { key: "Country of Origin", required: true },
];
